  ...
  return (
    <section className="py-24 bg-[#F5F4F2] px-6 md:px-12">
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="flex flex-wrap justify-center gap-6 md:gap-10 mb-20 border-b border-gray-200 pb-6 text-[11px] tracking-[0.2em] font-medium text-gray-400">
          {categories.map((cat) => (
            <button
              key={cat}
        ...
        >
          <AnimatePresence mode="popLayout">
            {filteredProducts.map((product) => (
              ...
              >
                <div className="w-full aspect-[4/5] bg-[#EAE8E4] p-8 flex items-center justify-center relative overflow-hidden rounded-sm mb-6">
                  {product.tag && (
                ...
                <h3 className="text-xl font-serif text-[#1A1A1A] mb-2 px-4">
                  {product.name}
                </h3>
